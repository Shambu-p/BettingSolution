...
const chargerConnectorDefination = {
    "name": "charger_connector",
    "backup_order": 15,
    title: "Charger Connector",
    id: "charger_connector",
    ...
    relatedList: [
        {
            "id": "ref_charger_transactions",
            "table": "charger_trx",
            label: "Transactions",
            "column_id": "connector_id",
            "order": 1,
            "readRoles": [UserRoles.Admin, UserRoles.ChargeStationOwner, UserRoles.ChargeStationOperator]
        }
    ],
...
module.exports = chargerConnectorDefination;