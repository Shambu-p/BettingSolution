...
async function updateServiceAfter(reqUser, data, changes, dependencies, smsService) {
    ...
    if(is_next_payment_date_changed) {
        ...
        await DefaultController.create(SystemUser, "transaction", {
            category: TransactionCategory.serviceFee,
            type: TransactionType.credit,
            status: true,
            amount: data.price,
            service_id: data.sys_id
...
module.exports = updateServiceAfter;