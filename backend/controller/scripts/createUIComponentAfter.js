...
async function createUIComponentAfter(reqUser, data, dependencies, smsService) {
    ...
    uiManager.updateRouteMapping(routeMapping.desktop, routeMapping.mobile);
...
module.exports = createUIComponentAfter;