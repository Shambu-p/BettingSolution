...
function AccountPage() {
    ...
    const [fields, setFields] = useState<any>({
        first_name: loggedUser.full_name,
        last_name: "",
        email: loggedUser.email,
        phone_number: loggedUser.phone,
        is_active: loggedUser.active
    ...
    const submit = async () => {
        ...
        try {
           ...
           if(Id){
            let result = await MainAPI.update(cookies.login_token, `user`, {full_name: `${fields.first_name} ${fields.last_name}`});
    ...
    const submitEmailOrPhone = async () => {
        ...
        try {
            ...
            if (Id) {
                ...
                let result = await MainAPI.update(cookies.login_token, `user`, {
    ...
    return (
        <div className="w-100 p-3">
            ...
            <div className="w-100 px-4 rounded-3 shadow-sm py-3" style={{background: "var(--panel_bg)"}}>
                <div className="d-flex py-3 justify-content-between mb-4 border-bottom">
                    <div className="" style={{position: "relative"}}>
                        ...
                        <h3 className="card-title" style={{color: `var(--text_color)`}}>{`${loggedUser.full_name}`}</h3>
                        <span style={{width: "100px", color: `var(--border_color) !important`}} className="card-subtitle">My Website address is here</span>
                    </div>
